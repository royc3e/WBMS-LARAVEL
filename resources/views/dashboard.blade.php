...
<div class="space-y-8">
    ...
    {{-- ================================================ --}}
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 px-6 py-7 shadow-lg shadow-blue-200">
        {{-- Background pattern --}}
        <div class="absolute inset-0 opacity-[0.06]"
            style="background-image: radial-gradient(circle at 1px 1px, white 1px, transparent 0); background-size: 28px 28px;">
        </div>
        {{-- Bottom wave --}}
        <svg class="absolute bottom-0 left-0 right-0 w-full opacity-10 text-white" viewBox="0 0 1440 80" preserveAspectRatio="none" fill="currentColor">
        ...
        <div class="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex-shrink-0">
                <div class="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm px-4 py-2.5 shadow-inner">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div class="group bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 p-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 group-hover:bg-slate-200 transition-colors">
        ...
        <div class="group bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 p-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-green-100 flex items-center justify-center text-green-600 group-hover:bg-green-200 transition-colors">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-4 pt-4 border-t border-slate-50">
                ...
                <p class="text-xs text-slate-400 mt-1.5">
                    {{ $totalConsumers > 0 ? round(($activeConsumers / $totalConsumers) * 100) : 0 }}% of total consumers
                </p>
            </div>
        </div>
        ...
        <div class="group bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 p-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-red-100 flex items-center justify-center text-red-500 group-hover:bg-red-200 transition-colors">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-4 pt-4 border-t border-slate-50 flex items-center gap-1.5">
                ...
                @else
                    <span class="inline-flex items-center gap-1 text-xs font-semibold text-green-500 bg-green-50 px-2 py-0.5 rounded-full">
        ...
        <div class="group bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 p-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-blue-100 flex items-center justify-center text-blue-600 group-hover:bg-blue-200 transition-colors">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="{{ route('consumers.create') }}"
                ...
                <div class="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10 group-hover:bg-white/15 transition-colors"></div>
                <div class="h-10 w-10 rounded-xl bg-white/15 flex items-center justify-center mb-4 group-hover:bg-white/25 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 lg:col-span-2">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                ...
                <div class="flex items-center gap-1 bg-slate-50 rounded-lg p-1 border border-slate-100">
                    <button class="px-3 py-1.5 text-xs font-semibold rounded-md bg-blue-600 text-white shadow-sm">Monthly</button>
                    <button class="px-3 py-1.5 text-xs font-medium rounded-md text-slate-500 hover:text-slate-700 hover:bg-white transition-colors">Quarterly</button>
                    <button class="px-3 py-1.5 text-xs font-medium rounded-md text-slate-500 hover:text-slate-700 hover:bg-white transition-colors">Yearly</button>
                </div>
            </div>
            ...
            <div class="h-52 flex items-end justify-between gap-2 px-2 mb-3">
                ...
                <div class="flex-1 flex flex-col items-center gap-1">
                    ...
                    <div class="w-full rounded-t-lg {{ $color }} transition-all duration-500 hover:opacity-80" style="height: {{ $height }}%;"></div>
                </div>
                @endforeach
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('payments.index') }}" class="text-xs font-bold text-blue-600 hover:text-blue-700 transition-colors">View All →</a>
            </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Current performance</p>
                    </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
                        <div class="flex-shrink-0 mt-0.5 h-2 w-2 rounded-full bg-emerald-500 shadow-[0_0_6px_rgba(16,185,129,0.5)]"></div>
                        <div>
