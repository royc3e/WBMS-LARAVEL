...
<body
    class="font-sans antialiased text-gray-900 bg-slate-50 min-h-screen selection:bg-blue-300 selection:text-blue-900">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row w-full selection:bg-blue-300 selection:text-blue-900">
        ...
        <div
            class="relative w-full lg:w-5/12 xl:w-1/2 flex flex-col justify-center items-center text-white bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 overflow-hidden py-16 px-6 sm:px-12">
            ...
            <div class="relative z-10 text-center max-w-lg mx-auto flex flex-col items-center">
                ...
                <div
                    class="mb-10 inline-flex items-center justify-center rounded-full p-2 bg-white/10 backdrop-blur-xl shadow-[0_0_60px_rgba(255,255,255,0.25)] ring-1 ring-white/30 relative group hover:ring-white/60 hover:bg-white/20 transition-all duration-500 ease-out transform hover:scale-105">
                    <!-- Dynamic Rotating Glow -->
                    <div
                        class="absolute inset-0 rounded-full bg-blue-300 opacity-20 blur-2xl group-hover:opacity-40 transition-opacity duration-500">
                    </div>
                    <img src="{{ asset('images/maribulan-seal.png') }}" alt="Barangay Maribulan Seal"
                ...
                <div class="space-y-4">
                    ...
                    <h1
                        class="text-4xl sm:text-5xl lg:text-5xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-br from-white to-blue-100 drop-shadow-sm">
                ...
                <!-- Sleek Glass Badge -->
                <div
                    class="mt-10 inline-flex px-6 py-2.5 rounded-full border border-white/20 bg-black/10 backdrop-blur-md shadow-inner text-blue-50 font-medium text-sm tracking-widest uppercase">
        ...
        <div
            class="w-full lg:w-7/12 xl:w-1/2 flex flex-col justify-center items-center py-12 px-6 sm:px-16 lg:px-24 relative bg-slate-50">

            <div class="w-full max-w-[420px] relative z-10">

                <!-- Abstract Glow Behind Form -->
                <div
                    class="absolute top-0 right-0 -m-8 w-32 h-32 bg-blue-400 opacity-10 rounded-full blur-3xl pointer-events-none">
                </div>
                <div
                    class="absolute bottom-0 left-0 -m-8 w-40 h-40 bg-indigo-400 opacity-10 rounded-full blur-3xl pointer-events-none">
                </div>

                <!-- Glassmorphism Form Card -->
                <div
                    class="bg-white/70 backdrop-blur-lg rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-900/5 p-8 sm:p-10 transition-all duration-300 hover:shadow-[0_8px_40px_rgb(0,0,0,0.08)]">

                    <!-- Form Header -->
                    <div class="mb-10 text-center sm:text-left">
                        <h2
                            class="text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">
                            Welcome Back
                        </h2>
                    ...
                    @if (session('status'))
                        <div
                            class="mb-6 flex items-center gap-3 text-sm font-medium text-green-700 bg-green-50/80 backdrop-blur-sm p-4 rounded-xl border border-green-200">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="group">
                            <label for="email"
                                class="block text-sm font-semibold text-gray-700 mb-1.5 transition-colors group-focus-within:text-blue-600">Email
                                Address</label>
                            <div class="relative">
                                <div
                                    class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-blue-500 text-gray-400">
                        ...
                        <div class="group">
                            <div class="flex items-center justify-between mb-1.5">
                                <label for="password"
                                    class="block text-sm font-semibold text-gray-700 transition-colors group-focus-within:text-blue-600">Password</label>
                        ...
                        <div class="flex items-center pt-2">
                            ...
                            <label for="remember_me"
                                class="ml-3 text-sm font-medium text-gray-600 cursor-pointer select-none">
