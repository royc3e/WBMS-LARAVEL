        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    ...
                    @if(($billing->penalty ?? 0) > 0)
                    {{-- Penalty --}}
                    <div class="flex items-start justify-between bg-red-50 border border-red-100 rounded-lg px-4 py-3">
                        <div>
                            <p class="text-xs font-medium text-red-500">Overdue Penalty (5%)</p>
                            <p class="text-sm font-semibold text-red-600 mt-0.5">
                                ₱{{ number_format($billing->penalty, 2) }}
                            </p>
                        </div>
                        <div class="h-7 w-7 rounded-md bg-red-100 flex items-center justify-center flex-shrink-0 mt-0.5">
