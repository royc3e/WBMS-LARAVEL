...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <a href="{{ route('consumers.create') }}" class="group bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-xl p-4 transition-all duration-200 hover:shadow-lg hover:shadow-indigo-500/20">
        ...
        <a href="{{ route('billings.index') }}" class="group bg-gradient-to-br from-green-600 to-green-800 rounded-xl p-4 transition-all duration-200 hover:shadow-lg hover:shadow-green-500/20">
            <div class="flex items-center justify-between">
                <div class="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('reports.index') }}" class="group bg-gradient-to-br from-amber-600 to-amber-800 rounded-xl p-4 transition-all duration-200 hover:shadow-lg hover:shadow-amber-500/20">
            <div class="flex items-center justify-between">
                <div class="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('billings.index') }}" class="group bg-gradient-to-br from-purple-600 to-purple-800 rounded-xl p-4 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/20">
            <div class="flex items-center justify-between">
                <div class="h-10 w-10 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <!-- Active Consumers -->
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-all duration-200 hover:shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-slate-800 dark:text-white">{{ \App\Models\Consumer::count() }}</p>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-all duration-200 hover:shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><span class="text-emerald-500 font-medium">+8.2%</span> from last month</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-all duration-200 hover:shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><span class="text-rose-500 font-medium">+5.6%</span> from last month</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-all duration-200 hover:shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><span class="text-emerald-500 font-medium">-2.3%</span> more efficient</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 lg:col-span-2">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-2">
                    <button class="px-3 py-1 text-xs font-medium rounded-lg bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">Monthly</button>
                    <button class="px-3 py-1 text-xs font-medium rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700">Quarterly</button>
                    <button class="px-3 py-1 text-xs font-medium rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700">Yearly</button>
                </div>
            </div>
            ...
            <div class="h-64 bg-slate-50 dark:bg-slate-900/50 rounded-lg flex items-center justify-center">
                <div class="text-center p-6">
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">Revenue and consumption chart will appear here</p>
                </div>
            </div>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg">
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400"><span class="text-emerald-500 font-medium">+8.2%</span> vs last month</p>
                </div>
                <div class="p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg">
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg">
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400"><span class="text-emerald-500 font-medium">+15%</span> efficiency</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="#" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">View All</a>
            </div>
            ...
            <div class="mt-6 text-center">
                <a href="#" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 lg:col-span-2">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-2">
                    <select class="text-sm rounded-lg border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
            ...
            <div class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400"><span class="text-emerald-500 font-medium">+5.2%</span> vs last month</p>
                    </div>
                    <button class="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-700 dark:hover:bg-indigo-600">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">Processing payments and generating bills</p>
                    </div>
                </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="#" class="p-3 bg-slate-50 dark:bg-slate-800 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                        <div class="flex items-center">
                            <div class="p-2 rounded-lg bg-indigo-100 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400 mr-3">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
